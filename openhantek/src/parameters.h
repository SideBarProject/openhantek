...
struct AnalyzerSettings : public DSOAnalyzer::AnalyzerSettings {
    Q_GADGET
    public:
    void assign(const DSOAnalyzer::AnalyzerSettings& d) {
    ...
    //Q_ENUMS(DSOAnalyzer::MathMode)
    //Q_ENUMS(DSOAnalyzer::WindowFunction)
    ...
    Q_PROPERTY(DSOAnalyzer::MathMode mathmode MEMBER mathmode)
    Q_PROPERTY(DSOAnalyzer::WindowFunction spectrumWindow MEMBER spectrumWindow)
