...
struct DsoSettingsScopeHorizontal {
    ...
    unsigned int downsampling; /// <downsampling rate for long time base
...
//    QList<DsoSettingsScopeVoltage> voltage; ///< Settings for the normal graphs
    QList<DSO::dsoSettingsChannel> voltage; ///< Settings for the normal graphs

	unsigned int physicalChannels; ///< Number of real channels (No math etc.)
    DSOAnalyzer::WindowFunction spectrumWindow; ///< Window function for DFT
