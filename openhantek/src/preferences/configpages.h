...
class DsoConfigAnalysisPage : public QWidget {
    ...
    public:
        DsoConfigAnalysisPage(OpenHantekSettings *settings, QWidget *parent = 0);
...
class DsoConfigColorsPage : public QWidget {
    ...
    public:
        DsoConfigColorsPage(OpenHantekSettings *settings, QWidget *parent = 0);
        ~DsoConfigColorsPage();
...
class DsoConfigFilesPage : public QWidget {
    ...
    public:
        DsoConfigFilesPage(OpenHantekSettings *settings, QWidget *parent = 0);
        ~DsoConfigFilesPage();
...
class DsoConfigScopePage : public QWidget {
    ...
    public:
        DsoConfigScopePage(OpenHantekSettings *settings, QWidget *parent = 0);
        ~DsoConfigScopePage();
