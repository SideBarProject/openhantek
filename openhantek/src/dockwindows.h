...
class HorizontalDock : public QDockWidget {
	...
	protected:
        ...
        QComboBox *samplerateComboBox; /// sample rate settings
        ...
        QStringList samplingrateStrings; ///< Strings for the sampling rates
        QStringList recordLengthStrings; ///< record lengths available on the HW
...
class TriggerDock : public QDockWidget {
	...
	public:
        TriggerDock(DsoSettings *settings, QWidget *parent = 0, Qt::WindowFlags flags = 0);
		~TriggerDock();
...
class VoltageDock : public QDockWidget {
	...
	public:
        ...
        int setMode(DSOAnalyzer::MathMode mode);
	...
	signals:
        ...
        void modeChanged(DSOAnalyzer::MathMode mode); ///< The mode for the math channels has been changed
