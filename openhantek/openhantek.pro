...
LIBS += -L../libDemoDevice -L../libOpenHantek60xx -L../libPostprocessingDSO -L../libusbDSO \
        -lDemoDevice -lOpenHantek60xx -lPostprocessingDSO -lusbDSO -lusb-1.0 -lfftw3
...
# Include directory
QMAKE_CXXFLAGS += "-iquote $${INCLUDEPATH_QUOTE}" -std=c++11
